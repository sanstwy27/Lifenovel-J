...
class PhotoForm extends React.Component {
  ...
  handleSubmit(e) {
    ...
    formData.append('user[profilePhoto]', this.state.photoFile);
    formData.append('currentUser', JSON.stringify(this.props.currentUser));
  ...
  render() {
    const preview = this.state.photoUrl ? <img className="preview" alt="" src={this.state.photoUrl} />
